...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    void Start() {
        ...
        containerStartPos = _container.anchoredPosition;
        ...
        //contButton.onClick.AddListener(resetPages);
    }
    ...
    {
    	//_container.anchoredPosition = containerStartPos;
        SetPage(startingPage);
    }
    //------------------------------------------------------------------------
...
//http://sbcgamesdev.blogspot.co.uk/2015/07/unity-tutorial-swipe-controlled.html
